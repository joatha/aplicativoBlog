...
router.post("/categorias/edit", (req,res)=>{
   Categoria.findOne({_id:req.body.id}).then((categoria)=>{
    ...
    categoria.save().then(()=>{
       ...
       req.flash("error_msg","Houve um erro ao editar a cateogira")
       res.redirect("/admin/categorias")
   })
})
...
router.get("/postagens/edit/:id", (req, res)=>{
    ...
    Postagem.findOne({_id: req.params.id}).lean().then((postagens)=>{
        ...
        Categoria.find().lean().then((categoria)=>{
            res.render("admin/aditpostagens", {categoria: categoria, postagens: postagens})
        ...
        req.flash("error_msg", "Houve um erro ao carregar o fumulario de edição")
        res.redirect("/admin/postagens")
    })
})
